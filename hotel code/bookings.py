...
if __name__ == "__main__":
    ...
    rooms_df = pd.read_csv("hotel data/hotel_chain_rooms.csv")
    hotels_df = pd.read_csv("hotel data/hotel_chain_hotels.csv")
    staff_df = pd.read_csv("hotel data/hotel_chain_staff.csv")
    ...
    output_file = 'hotel data/hotel_chain_bookings.csv'
